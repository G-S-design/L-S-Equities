...
if days_stale <= 5:
    ...
    print(f"    Data ends {actual_end.date()} — {days_stale} days stale")
...
if bad.empty:
    ...
    print(f"    {len(bad)} tickers with >5% NaN (will be forward-filled):")
...
if bad_zeros:
    print(f"   Zero/negative prices found in: {bad_zeros}")
else:
